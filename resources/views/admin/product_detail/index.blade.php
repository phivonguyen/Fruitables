    ...
    <div class="container-scroller">
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
          <a class="sidebar-brand brand-logo" href="../../index.html"><img src="../../bf1.png" alt="logo" /></a>
          <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="../../index.html"><img src="../../bf1.png" alt="logo" /></a>
        </div>
        <ul class="nav">
          <li class="nav-item nav-profile">
            <a href="#" class="nav-link">
              <div class="nav-profile-image">
                <img src="../../assets/images/cat copy.jpeg" alt="profile" />
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="{{route("product_detail/create")}}">Create</a></li>
    ...
    <div class="container mt-3">
        <table class="table table-striped" border=1>
          ...
          <tbody>
            ...
            <tr>
                <td>
                  <img src="{{ asset('storage/uploads/'.$item->image) }}" alt="Product Image" style="max-width: 300px;">
                </td>                   
                <td>{{$item->name}}</td>
                ...
                <td>
                  <a href="{{ route('product_detail/edit', $item->id) }}" class="btn btn-warning">Edit</a>
                  <a href="{{route("product_detail/delete",$item->id)}}" class="btn btn-danger">Delete</a>
                </td>
            </tr>
            @endforeach
          </tbody>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"><a href=""> Beautiful Flower</a> All Rights Reserved </span>            </div>
          </footer>
        </div>
        <!-- main-panel ends -->
      </div>
...
<body>
    <div class="container-scroller">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
                <a class="sidebar-brand brand-logo" href="../../index.html"><img src="../../bf1.png"
                        alt="logo" /></a>
                <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="../../index.html"><img src="../../bf1.png"
                        alt="logo" /></a>
            </div>
            <ul class="nav">
                <li class="nav-item nav-profile">
                                    ...
                                    <tr>
                                        <td>
                                            <img src="{{ asset('storage/uploads/' . $item->image) }}"
                                                alt="Product Image" style="max-width: 300px;">
                                        </td>
                                        <td>{{ $item->name }}</td>
                                        <td>{{ $item->description }}</td>
                                        <td>{{ $item->price }}</td>
                                        <td>{{ $item->category_id }}</td>
                                        <td>
                                            <a href="{{ route('product_detail/edit', $item->id) }}"
                                                class="btn btn-warning">Edit</a>
                                            <a href="{{ route('product_detail/delete', $item->id) }}"
